...
export default function Topbar() {
  return (
    <>
      <section className="fixed top-0 w-full z-10 m-0 overflow-hidden shadow-md dark:shadow-gray-800 py-3 bg-white dark:bg-slate-900 transition-colors duration-200 ease-in">
        <Container wide>
